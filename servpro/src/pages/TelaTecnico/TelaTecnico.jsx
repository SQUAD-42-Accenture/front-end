...
// import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField, Button, IconButton, Pagination, Modal, Box } from '@mui/material';
...
//   useEffect(() => {
//     axios.get('https://servpro.onrender.com/api/OrdemDeServico')
//       .then((response) => {
...
//     axios.put(`https://servpro.onrender.com/api/OrdemDeServico/${selectedOrdem.Id}`, {
//       Status: novoStatus,
...
//             <Button onClick={handleConfirmarAlteracao} color="primary" style={{ marginLeft: '10px' }}>Confirmar</Button>
//           </div>
//         </Box>
//       </Modal>
//     </div>
