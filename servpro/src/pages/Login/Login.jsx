...
//               const ordensResponse = await axios.get(
//                 "https://servpro.onrender.com/api/OrdemDeServico",
//                 {
//                   headers: { Authorization: `Bearer ${token}` },
//                 }
//               );
...
//               console.log("Ordens de Serviço para Administrador:", todasOrdens);

//               navigate("/menu", { state: { todasOrdens } });
//             } catch (err) {
//               console.error(
//                 "Erro ao buscar ordens de serviço para Administrador:",
...
//             } catch (err) {
//               console.error(
//                 "Erro ao buscar ordens de serviço para Técnico:",
//                 err.response?.data || err.message
//               );
//               setError(
        ...
        switch (perfil) {
          ...
          case "Cliente":
            try {
              ...
              const ordensResponse = await axios.get(
                `https://servpro.onrender.com/api/Cliente/ordens/${cpf}`,
                {
                  headers: { Authorization: `Bearer ${token}` },
                }
              );

              const ordensCliente = ordensResponse.data;
              console.log("Ordens de Serviço do Cliente:", ordensCliente);
              navigate("/telacliente", { state: { ordensCliente } });
            } catch (err) {
              console.error(
                "Erro ao buscar ordens de serviço para Cliente:",
                err.response?.data || err.message
              );
              setError("Erro ao carregar ordens de serviço. Tente novamente.");
            }
