        ...
        <div className='back'>
            ...
            <div className='boxs'>
                ...
                <div className='tudo'>
                    ...
                    <p>Adeus aos papéis e planilhas. Organize tudo à um clique de distância.</p>
                </div>
            ...
            <div className='conteudoSecundario'>
                ...
                <div className='sessaoDois'>
                    ...
                    <div className='textos'>
                        ...
                        <h2 className='continuaTitleSessaoDois'>Status das Ordens de Serviços</h2>
                        <img className="underlineDois" src={underline} alt="" />
                        <p>Acompanhe o status de cada serviço e tenha total controle sobre as demandas da sua equipe.</p>
                    </div>
                </div>
            </div>
            <div className='conteudoTres'>
                ...
                <div className='textosDois'>
                    ...
                    <p>A ServPro é um sistema online projetado para otimizar a gestão de serviços de assistência técnica,
                        facilitando a organização de clientes, técnicos e aparelhos.</p>
                    <p>Oferecemos uma interface intuitiva que permite o gerenciamento eficiente de todas as operações da empresa,
                        garantindo também o acompanhamento de todos os processos.</p>
                </div>
            </div>
            <div className='conteudoQuatro'>
                <div className='textosTrês'>
                    <h2 className='tituloQuatro'>Nossa Plataforma</h2>
                    <p>Organize e delegue ordens de serviço de forma inteligente,
                        otimizando o tempo e recursos de sua equipe técnica.</p>
                    <p>Reduza o tempo gasto em tarefas manuais com automação completa do fluxo de trabalho.</p>
                </div>
            ...
            <div className='conteudoOito'>
                ...
                <div className='parteDois'>
                    <div className='textosParteDois'>
                        <h2 className='tituloNove'>Simplifique sua Assistência Técnica com Nossa Plataforma</h2>
                        <img className="underlineQuatro" src={underline} alt="" />
                        <p>Está cansado de perder tempo com processos manuais e desorganizados?</p>
                    </div>
                ...
                <div className='parteTres'>
                    <div className='miniSessao'>
                        ...
                        <p> Criada para transformar a forma como você lida com ordens de serviço,
                            aumentando sua produtividade.</p>
                    </div>
                    <div className='miniSessao'>
                        <h2 className='tituloOnze'>Gestão simplificada de OS</h2>
                        <p>Crie, edite e acompanhe ordens de serviço de forma rápida e intuitiva.</p>
                    </div>
                </div>
            </div>
