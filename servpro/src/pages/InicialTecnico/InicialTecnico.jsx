...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField, Button, IconButton, Pagination,
    Typo
 } from '@mui/material';
  ...
  return (
    <div style={{ padding: '20px', marginTop: '10px' }}> 
      <div style={{
        ...
        <h2 style={{ color: '#727070', marginBottom: '10px' }}>Ordens de Serviço</h2>
